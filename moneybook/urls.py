...
urlpatterns = [
    ...
    path('tools/update_now_bank', toolsView.update_now_bank, name="update_now_bank"),
    path('tools/unchecked_transaction', toolsView.get_unchecked_transaction, name="unchecked_transaction"),
