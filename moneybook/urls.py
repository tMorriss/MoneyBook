...
from moneybook.views import (ActualCashView, AddIntraMoveView, AddView,
                             ...
                             PeriodBalanceView, PeriodicAddBulkView, PeriodicConfigView,
                             PeriodicListView, PreCheckedSummaryView, PreCheckView, SearchView,
...
urlpatterns = [
    ...
    path('periodic', PeriodicListView.as_view(), name='periodic_list'),
    path('periodic/config', PeriodicConfigView.as_view(), name='periodic_config'),
    path('periodic/add_bulk', PeriodicAddBulkView.as_view(), name='periodic_add_bulk'),
